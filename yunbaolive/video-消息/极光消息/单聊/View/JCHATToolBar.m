      ...
      [audioSession performSelector:@selector(requestRecordPermission:) withObject:^(BOOL granted) {
        if (granted) {
          ...
          dispatch_async(dispatch_get_main_queue(), ^{
              UIAlertController *alertC = [UIAlertController alertControllerWithTitle:@"无法录音" message:@"请在“设置-隐私-麦克风”选项中，允许jpushIM访问你的手机麦克风。" preferredStyle:UIAlertControllerStyleAlert];
...
- (void)awakeFromNib {
  ...
  _toolbar = NIB(JCHATToolBar);
    ...
    _toolbar.textView.placeHolder = @"发送消息...";
