...
-(void)pullInternetforNew{
    ...
    [YBToolClass postNetworkWithUrl:_url andParameter:[NSDictionary dictionaryWithObjectsAndKeys:[cityDefault getMylng],@"lng",[cityDefault getMylat],@"lat", nil] success:^(int code, id  _Nonnull info, NSString * _Nonnull msg) {
        if(code == 0)
        {
            NSArray *infos = info;
            self.allArray = infos;
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    switch (type) {
        case 0:
            [cell.typeimagev setImage:[UIImage imageNamed:@"普通"]];
            break;
        case 1:
            [cell.typeimagev  setImage:[UIImage imageNamed:@"密码"]];
            break;
        case 2:
            [cell.typeimagev  setImage:[UIImage imageNamed:@"付费"]];
            break;
        case 3:
            [cell.typeimagev  setImage:[UIImage imageNamed:@"计时"]];
            break;
        default:
            break;
    }
