...
@interface attentionViewC ()<UICollectionViewDelegate,UICollectionViewDataSource,UIScrollViewDelegate,SDCycleScrollViewDelegate>
{
    ...
    UIView *collectionHeaderView;  //collection头视图
}
...
@property(nonatomic,strong)SDCycleScrollView * sdScrollView; // 轮播图
...
- (void)viewDidLoad {
    ...
    self.backScrollView.frame = CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT - 55 - 64);
    ...
    [self.backScrollView addSubview:headerView];
    ...
    flow.headerReferenceSize = CGSizeMake(_window_width, 210);
...
- (void)createCollectionHeaderView {
    ...
    collectionHeaderView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, _window_width, 210)];
    collectionHeaderView.backgroundColor = [UIColor whiteColor];
    
    self.sdScrollView = [SDCycleScrollView cycleScrollViewWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 180) delegate:self placeholderImage:[UIImage imageNamed:@"placeholder"]];
    
    NSArray * scrollViewImage = @[@"live_计时",@"live_密码",@"live_普通"];
//    weakSelf.scrollView.imageURLStringsGroup = weakSelf.imageUrlArray;
    self.sdScrollView.imageURLStringsGroup = scrollViewImage;

    self.sdScrollView.placeholderImage = [UIImage imageNamed:@"placeholder"];
    
//    self.sdScrollView.pageControlBottomOffset = 0;
    ...
    self.sdScrollView.titlesGroup = nil;
    self.sdScrollView.currentPageDotColor = [UIColor redColor]; // 自定义分页控件小圆标颜色
//    [view addSubview:self.scrollView];
    
//    UIImageView * imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 150)];
//    imageView.backgroundColor = [UIColor cyanColor];
    UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(10, 180, 200, 30)];
    label.text = @"热门";
    label.font = [UIFont boldSystemFontOfSize:15];
    [collectionHeaderView addSubview:self.sdScrollView];
...
//    labelSecond.text = @"去首页看看其他主播的直播吧～";
