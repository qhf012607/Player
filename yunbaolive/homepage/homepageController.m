...
- (void)viewDidLoad {
    ...
    self.cellSpacing = 8;
//    self.infoArrays = [NSArray arrayWithObjects:@"关注",@"直播",@"视频", nil];
...
//    [self.pagerBarView addSubview:searchBTN];
    ...
    [[YBToolClass sharedInstance] lineViewWithFrame:CGRectMake(0, CGRectGetMaxY(self.pagerBarView.frame), _window_width, 1) andColor:[UIColor colorWithRed:0.96f green:0.96f blue:0.96f alpha:1.00f] andView:self.pagerBarView];
