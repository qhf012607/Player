...
//        [_likeBtn setImage:[UIImage imageNamed:@"收藏"] forState:UIControlStateNormal];
//        [_likeBtn addTarget:self action:@selector(onLikeClike) forControlEvents:UIControlEventTouchUpInside];
    }
    return _likeBtn;
}
...
- (UIButton *)commentBtn {
    if (!_commentBtn) {
        ...
        [_commentBtn setImage:[UIImage imageNamed:@"消息"] forState:UIControlStateNormal];
    }
    return _commentBtn;
}
