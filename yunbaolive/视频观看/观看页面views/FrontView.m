...
//        _rightView = [[UIView alloc]initWithFrame:CGRectMake(_window_width-rv_w, _window_height-rv_all_h-49-ShowDiff, rv_w, rv_all_h)];
        ...
        [_rightView mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.width.mas_equalTo(rv_w);
            make.height.mas_equalTo(rv_all_h);
...
- (UIView *)botView {
    if (!_botView) {
       ...
       // CGRectMake(10, _window_height-49-ShowDiff-110, _window_width*0.75, 100)
        [_botView mas_updateConstraints:^(MASConstraintMaker *make) {
            make.left.mas_equalTo(10);
            make.bottom.mas_equalTo(-75);
            make.width.mas_equalTo(240);
            make.height.mas_equalTo(100);
        }];
      //  _botView.backgroundColor = [UIColor redColor];
...
- (void)callBackEvent:(FrontBlock)event
{
    self.frontEvent = event;
}
@end
