...
-(void)setUI
{
    ...
    self.liveBtn =  [self YBBottomButton:self.liveBtn title:@"直播" titleFont:16  numValue:_numArr[0]];
    self.forceBtn = [self YBBottomButton:self.forceBtn title:@"关注" titleFont:16 numValue:_numArr[1]];
    self.fanBtn =   [self YBBottomButton:self.forceBtn title:@"粉丝" titleFont:16 numValue:_numArr[2]];
