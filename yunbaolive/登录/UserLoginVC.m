...
- (void)viewDidLoad {
    ...
    //手机登录、注册
    NSMutableAttributedString *str = [[NSMutableAttributedString alloc] initWithString:@"手机号登录/注册"];
    ...
    NSMutableAttributedString *attStr=[[NSMutableAttributedString alloc]initWithString:@"登录即代表你同意《服务和隐私协议》"];
    [attStr addAttribute:NSForegroundColorAttributeName value:RGB(248, 208, 119) range:NSMakeRange(8, 9)];
