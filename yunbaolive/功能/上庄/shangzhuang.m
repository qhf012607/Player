            ...
            [YBToolClass postNetworkWithUrl:url andParameter:nil success:^(int code, id  _Nonnull info, NSString * _Nonnull msg) {
                if (code == 0) {
                    ...
                    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(1.0 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
                        ...
                        panduanalert = [[UIAlertView alloc]initWithTitle:@"上庄押金" message:@"" delegate:self cancelButtonTitle:@"取消" otherButtonTitles:@"确定", nil];
...
-(void)dorecord{
    ...
    */
    ...
    NSString *url;
    if ([recordbtn.titleLabel.text isEqual:@"申请上庄"]) {
        panduanalert = [[UIAlertView alloc]initWithTitle:@"上庄押金" message:@"" delegate:self cancelButtonTitle:@"取消" otherButtonTitles:@"确定", nil];
        ...
        [YBToolClass postNetworkWithUrl:url andParameter:nil success:^(int code, id  _Nonnull info, NSString * _Nonnull msg) {
            if (code == 0) {
                ...
                UIAlertView *alert = [[UIAlertView alloc]initWithTitle:msg message:@"" delegate:self cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
                [alert show];
...
//            }
//            else{
//                UIAlertView *alert = [[UIAlertView alloc]initWithTitle:[NSString stringWithFormat:@"%@",[data valueForKey:@"msg"]] message:@"" delegate:self cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
//                [alert show];
//            }
//        }
//        else{
//            UIAlertView *alert = [[UIAlertView alloc]initWithTitle:[NSString stringWithFormat:@"%@",[responseObject valueForKey:@"msg"]] message:@"" delegate:self cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
//            [alert show];
//        }
//    } failure:^(NSURLSessionDataTask * _Nullable task, NSError * _Nonnull error) {
//
...
-(void)addtableview{
    ...
    [recordbtn setTitle:@"申请上庄" forState:UIControlStateNormal];
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                for (NSDictionary *subdic in info) {
                    ...
                    if ([uid isEqual:[Config getOwnID]]) {
                        [recordbtn setTitle:@"下庄" forState:UIControlStateNormal];
                        break;
                    }
                    else{
                        [recordbtn setTitle:@"申请上庄" forState:UIControlStateNormal];
...
//获取上庄流水
-(void)getliushui{
    NSString *url = [NSString stringWithFormat:@"%@&stream=%@&uid=%@",@"Game.getBankerProfit",_stream,[_zhuangdic valueForKey:@"id"]];
    [YBToolClass postNetworkWithUrl:url andParameter:nil success:^(int code, id  _Nonnull info, NSString * _Nonnull msg) {
        if (code == 0) {
