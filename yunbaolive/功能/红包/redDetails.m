...
- (void)creatTableHeader:(NSDictionary *)dic{
    ...
    nameL.text = [NSString stringWithFormat:@"%@ 的红包",minstr([redinfo valueForKey:@"user_nicename"])];
    ...
    numL.text = [NSString stringWithFormat:@"已领取%@/%@个，共%@/%@%@",minstr([redinfo valueForKey:@"nums_rob"]),minstr([redinfo valueForKey:@"nums"]),minstr([redinfo valueForKey:@"coin_rob"]),minstr([redinfo valueForKey:@"coin"]),[common name_coin]];
