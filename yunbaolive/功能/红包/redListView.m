...
//            listInfo = info;
            ...
            numL.text = [NSString stringWithFormat:@"共%ld个红包",listInfo.count];
...
- (void)qiangBtnClickkk:(redListModel *)model andButton:(UIButton *)btn{
    ...
    [qiangBtnn setTitle:@"抢" forState:0];
    ...
    [xiangQingBtn setTitle:@"查看领取详情》" forState:0];
...
- (void)showSuccessView:(NSString *)coin{
    ...
    contentL.text = [NSString stringWithFormat:@"抢到 %@ 派发的%@红包",curModel.user_nicename,[common name_coin]];
    ...
    [xqBtn setTitle:@"查看领取详情》" forState:0];
