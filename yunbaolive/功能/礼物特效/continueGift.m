...
//    NSString *giftcount = @"1";
    ...
    labName.textColor = RGB_COLOR(minstr([levelDic valueForKey:@"colour"]), 1);
...
//        [GiftPopView mas_remakeConstraints:^(MASConstraintMaker *make) {
//            make.left.equalTo(self).offset(x);
//            make.top.equalTo(self).offset(y);
//            make.height.mas_equalTo(height);
//            make.width.mas_equalTo(width);
//        }];
//        [GiftPopView layoutIfNeeded];
//        [giftXImage mas_remakeConstraints:^(MASConstraintMaker *make) {
//            make.left.equalTo(giftImage.mas_right);
//            make.top.equalTo(giftBGView).offset(-15);
//            make.height.mas_equalTo(40);
//            make.width.mas_equalTo(56);
//        }];
//        [giftXImage layoutIfNeeded];
        [self layoutIfNeeded];
